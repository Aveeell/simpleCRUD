...
<body>
    ...
    <nav class="nav justify-content-center">
        <a class="nav-link" href="index.php">Вернуться на главную страницу</a>
            ...
            <div class="input-group justify-content-center">
                <form action="process.php" method="POST">
                    ...
                    <div>
                        ...
                        <input class="form-check-input" type="radio" value="1" name="status" checked> На парковке
                        <input class="form-check-input" type="radio" value="0" name="status"> Не на парковке
                    </div>
                    <div>
                    <br>
